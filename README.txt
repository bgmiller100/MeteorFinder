...
[1] Keh, R. & (2018). Maual_Input_Scraper.py
...
v0.1: Initial release.  KFWS fall confirmed with 1 ID at 16:53:32, with no false positves over the full date 2/15/2009.
...
The "Master_MeteorFinder.py" function provides a simple interface for selecting the following variables:
	...
	fillFilter: Precentage of velocity phenomena which must contain high velocity gradients, filtering out monovelocity phenomena.  (default 50) 
